...
declare const measurableLoadFiles: (pathToScan: string, options?: import("./types").IaCTestFlags | undefined, validFileTypes?: string[] | undefined) => Promise<import("./types").IacFileData[]>;
...
declare const measurableFormatScanResults: (scanResults: import("./types").IacFileScanResult[], options: import("./types").IaCTestFlags, meta: import("./types").TestMeta, projectPublicIds: Record<string, string>) => import("./types").FormattedResult[];
